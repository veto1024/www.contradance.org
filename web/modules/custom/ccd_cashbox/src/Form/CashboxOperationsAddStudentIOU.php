...
/**
 * CashboxOperationsAddStudentIOU class.
 */

class CashboxOperationsAddStudentIOU extends FormBase {
  ...
  return 'ccd_cashbox_operations_add_student_iou_form';
  }
  ...
  return ['config.ccd_cashbox_operations_add_student_iou_form'];
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $nid = $node->id();
    $node = Node::load($nid);
    $prev_value= $node->get('field_iou_dancers_student');
    $node->set('field_iou_dancers_student', $prev_value[0]->value + 1);
